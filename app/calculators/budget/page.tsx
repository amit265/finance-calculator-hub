  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-20">
          <Suspense fallback={<div className="h-[600px] w-full flex items-center justify-center border rounded-2xl bg-slate-50 text-muted-foreground animate-pulse">Loading calculator...</div>}><BudgetCalculator /></Suspense>
        </div>
